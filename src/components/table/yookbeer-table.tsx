...
import {
	type ColumnDef /* ColumnFiltersState, */,
	flexRender,
	getCoreRowModel,
	getFilteredRowModel,
...
import { COURSE_SHORTHAND, type StudentStatus } from "@/lib/const"
...
export function YookbeerTable({ data }: YookbeerTableProps) {
	...
	return (
		<div className="mx-10 min-h-screen w-[85vw] lg:w-[95vw]">
										...
										<TableCell
											...
											onClick={() => {
												if (cell.column.id !== "action") {
													redirect(`/std/${row.original.stdid}`, RedirectType.push)
												}
											}}
										>
